...
class debtforyou(QtWidgets.QWidget):
    def __init__(self):
         super().__init__()
         self.initUI()
    def finish1(self):
    ...
    def add(self):
         ...
         name=file1.readline()
         file=open(str("%sdebtforyou.txt"%name),"a")
         file.write(str("%s\n%s\n"%(self.lineEdit.text(),self.lineEdit_2.text())))
         self.lineEdit.clear()
         self.lineEdit_2.clear()
    def initUI(self):
         self.setWindowTitle("Debt For You")
         self.resize(425, 229)
         ...
         self.label.setText(_translate("Dialog", "- If you want to add more extra debt for you enter Add."))
         self.label_2.setText(_translate("Dialog", "- If you have finished entering debt for you enter Finish."))
         ...
         self.label_5.setText(_translate("Dialog", "Enter The Value Of  Debt For You    :"))
