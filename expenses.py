...
class expenses(QtWidgets.QWidget):
    def __init__(self):
         super().__init__()
         self.initUI()
    def finish1(self):
    ...
    def add(self):
         ...
         name=file1.readline()
         file=open(str("%sexpenses.txt"%name),"a")
    ...
    def initUI(self):
         ...
         self.label.setText(_translate("Dialog", "- If you want to add more expenses sources enter Add."))
         self.label_2.setText(_translate("Dialog", "- If you have finished entering expenses sources enter Finish."))
         self.label_3.setText(_translate("Dialog", "- If you want to exit enter close."))
         self.label_4.setText(_translate("Dialog", "Enter The Type Of  Expense Source :"))
         self.label_5.setText(_translate("Dialog", "Enter The Value Of Expense    :"))
