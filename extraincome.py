...
class extraincome(QtWidgets.QWidget):
    def __init__(self):
         super().__init__()
         self.initUI()
    def finish1(self):
    ...
    def add(self):
         ...
         name=file1.readline()
         file=open(str("%sextraincome.txt"%name),"a")
         file.write(str("%s\n%s\n"%(self.lineEdit.text(),self.lineEdit_2.text())))
         self.lineEdit.clear()
         self.lineEdit_2.clear()
    def initUI(self):
         self.setWindowTitle("Extra Income")
         self.resize(425, 229)
         ...
         self.label.setText(_translate("Dialog", "- If you want to add more extra income sources enter Add."))
         self.label_2.setText(_translate("Dialog", "- If you have finished entering extra income sources enter Finish."))
         self.label_3.setText(_translate("Dialog", "- If you want to exit enter close."))
         self.label_4.setText(_translate("Dialog", "Enter The Type Of  Extra Income Source :"))
         self.label_5.setText(_translate("Dialog", "Enter The Value Of Extra Income    :"))
